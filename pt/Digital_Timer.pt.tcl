...
read_verilog ./netlist/Digital_Timer.syn.v ;
...
set_dont_touch_network {"clk"  "rst" "I_SCAN_MODE" "I_SCAN_RST"} ;
set_ideal_network {"clk" "rst" "I_SCAN_MODE" "I_SCAN_RST"} ;
...
report_timing > report/$design_name.pt.timing ;
#report_area > report/$design_name.area ;

source /usr/local/synopsys/2011.09/tetramax/auxx/syn/tmax/pt2tmax.tcl 
write_delay_paths -max_paths 200 -nworst 1 -delay_type max ./report/timing200withoutmob.rpt
